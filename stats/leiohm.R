...
jpeg('../images/Vi1.jpg')
plot(ohm$i1, ohm$V, xlab="i(mA)", ylab="V(V)", xaxt="n", yaxt="n")
...
jpeg('../images/Vi2.jpg')
plot(ohm$i2, ohm$V, xlab="i(mA)", ylab="V(V)", xaxt="n", yaxt="n")
axis(side=1, at=seq(0, 2.0, 0.2), labels=sprintf("%.1f", seq(0, 2.0, 0.2)))
axis(side=2, at=ohm$V, labels=sprintf("%.0f", ohm$V))
abline(v=seq(0, 2, 0.2), col="lightgray", lty="dotted")
abline(h=ohm$V, col="lightgray", lty="dotted")
...
jpeg('../images/Vis.jpg')
plot(ohm$is, ohm$V, xlab="i(mA)", ylab="V(V)", xaxt="n", yaxt="n")
...
jpeg('../images/Vip.jpg')
plot(ohm$ip, ohm$V, xlab="i(mA)", ylab="V(V)", xaxt="n", yaxt="n")
